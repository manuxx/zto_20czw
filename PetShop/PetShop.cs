...
namespace Training.DomainClasses
{
    public class PetShop
    {
        ...
        {
            return _petsInTheStore.AllThat(IsSpecies(Species.Dog)).AllThat(IsBornAfter(2010));
        }

        public IEnumerable<Pet> AllMaleDogs()
        {
            return _petsInTheStore.AllThat(IsSpecies(Species.Dog)).AllThat(pet => pet.sex == Sex.Male);
        }
